...
(defun pretty-print (output)
  (if (erlang:is_list output)
    (io:format "~s" (list (pretty-print-all output)))
    (erlang:error (tuple 'compiler_error "Unreachable: Kanren output returned something that is not a list"))))
