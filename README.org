...
- [X] Modules
- [X] Integration Testing (testing Karuta programs directly)
- [ ] Unit Testing (testing stages of the compiler)
...
- [ ] Full Database Support (all operations)
- [ ] Embeddable VM Compilation
